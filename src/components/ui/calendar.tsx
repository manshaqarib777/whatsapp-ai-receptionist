...
function CalendarDayButton({
  ...
  // Hoisted out of the dependency array: `modifiers['focused']` inline is a complex
  // expression the linter cannot check statically, and depending on `modifiers`
  // itself would refocus on every render.

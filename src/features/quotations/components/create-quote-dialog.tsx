...
import { useCreateQuote } from '@/features/quotations/hooks/use-quotations';

/**
 * Create-quote dialog (M11). Line items with live VAT totals; the contact id is
 * a text field in M11 (the contact picker is the CRM surface).
 */

const VAT_RATE = 0.15;

/** Mirrors `computeTotals` in the service — client-side live preview only; the
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Line items are priced with 15% VAT. The quote starts as a draft.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="space-y-1.5">
              <Label htmlFor="quote-contact">Contact id</Label>
              <Input
                id="quote-contact"
                value={contactId}
        ...
        {create.isError ? (
          <p className="text-destructive text-sm">Could not create the quote.</p>
        ) : null}
        <DialogFooter>

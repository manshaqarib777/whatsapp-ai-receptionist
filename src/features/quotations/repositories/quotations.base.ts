...
/**
 * Shared quotations repository plumbing — Milestone 11.
 *
...
export abstract class QuotationsBaseRepository {
  ...
  static forOrganization<T extends QuotationsBaseRepository>(

...
/**
 * Shared broadcast repository plumbing — Milestone 14.
 *
...
export abstract class BroadcastBaseRepository {
  ...
  static forOrganization<T extends BroadcastBaseRepository>(

...
/**
 * Shared reviews repository plumbing — Milestone 16.
 *
 ...
 * (same pattern as broadcast.base.ts).
 */

export abstract class ReviewsBaseRepository {
  ...
  static forOrganization<T extends ReviewsBaseRepository>(

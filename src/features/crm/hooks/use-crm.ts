...
import type {
  ...
  Tag,
  Task,
} from '@/features/crm/hooks/crm.client-types';

export type { Activity, Company, Deal, Pipeline, Tag, Task } from './crm.client-types';
...
export function useAssignTag() {
  ...
  return useMutation({
    mutationFn: (input: {
      tagId: string;
      taggableType: 'contact' | 'deal' | 'conversation' | 'company';
      taggableId: string;
    }) =>
